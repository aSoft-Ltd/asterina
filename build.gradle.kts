...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/asterina")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/asterina/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/asterina/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/asterina.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/asterina.git")
            }
        }
    }
}
